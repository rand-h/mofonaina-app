...
| **Cantiques** | `/fihirana.html?hira=...` | **Paramètre `hira`** : Supporte `ffpm`, `ff`, `antema`, `tsanta`, `fif`. Remplacer l'espace par un *underscore* (`_`).<br> *Ex: `https://mofonaina-cabea.web.app/fihirana.html?hira=ffpm_12`* |
